...
Route::group(['prefix' => 'v1'], function() {
    ...
    Route::group(['prefix' => 'user'], function() {
        ...
        Route::delete('vehicle/{plate}', 'UserController@removePlateNumber')->middleware('auth:api');
        Route::get('vehicle/search', 'UserController@searchVehicle')->middleware('auth:api');
